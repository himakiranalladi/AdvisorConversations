...
"""
Created on Sun Dec 16 12:12:52 2018
...
'''
# ## Training a Neural Entity Detector using advisor conversation
...
run_logger.log('realworld-advisorconversations.log','true')
...
def main():
    ...
    train_file_path = os.path.join(data_folder, "advisorConversations_train.txt")
    test_file_path = os.path.join(data_folder, "advisorConversations_test.txt")    
    data_file_path = os.path.join(data_folder, "unlabeled_advisorConversations.txt")    
